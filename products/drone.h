...
/* Drone product profile — Camera, IMU, GPS, Motor, Radar, WiFi, BLE, PWM */
#ifndef EOS_PRODUCT_DRONE_H
#define EOS_PRODUCT_DRONE_H

#define EOS_PRODUCT_NAME    "drone"
