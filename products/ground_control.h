...
/* Ground control station — satellite/drone control */
#ifndef EOS_PRODUCT_GROUND_CONTROL_H
#define EOS_PRODUCT_GROUND_CONTROL_H
#define EOS_PRODUCT_NAME    "ground_control"
