...
#elif defined(EOS_PRODUCT_IPTV_STB)
#   include "products/iptv_stb.h"
#elif defined(EOS_PRODUCT_CAST_DEVICE)
#   include "products/cast_device.h"
#elif defined(EOS_PRODUCT_SMART_SPEAKER)
#   include "products/smart_speaker.h"
#elif defined(EOS_PRODUCT_HOME_CAMERA)
#   include "products/home_camera.h"
#elif defined(EOS_PRODUCT_TV_OS)
#   include "products/tv_os.h"
